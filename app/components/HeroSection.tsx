  ...
  return (
    <section className="flex flex-col items-center text-center p-10 bg-gradient-to-r from-green-400 to-blue-500">
      <div>
        ...
        <p className="mt-4 text-white">Accede a energía limpia y sostenible con Solargy. Descubre cómo reducir tus facturas energéticas y proteger el medio ambiente.</p>
